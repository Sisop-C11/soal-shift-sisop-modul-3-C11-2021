...
char *inputNamaFile(char *namaFile, char buff[]){
...
char *getExtension(char *namaFile, char buff[]){
...
void *routine(void* arg) {
  ...
  getNamaFile(buffFrom, buffNamaFile);
  strcpy(buffFrom, (char *) arg);
  ...
  sprintf(buffTo, "%s/%s/%s", cwd, buffExt, buffNamaFile);
